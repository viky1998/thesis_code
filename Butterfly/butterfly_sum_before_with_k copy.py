...
df_sum_before_with_l = butterfly.get_table_sum_before_with_l_specified_c(c, N_range)
pivot_sum_before_with_l = df_sum_before_with_l.pivot(index='l', columns='logn', values='sum_before_first_c')
